  ...
  describe('HttpHeaders', () => {
    describe('initialization', () => {
      ...
      it('should not throw an error when a number is passed as header', () => {
        // Note: Some libraries may set headers as numbers.
        // This test is to prevent throwing an error on headers initialization.
        const headers = new HttpHeaders({'Content-Length': 100 as any});
